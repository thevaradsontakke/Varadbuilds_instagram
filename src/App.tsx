...
export default function App() {
  ...
  const showToast = (msg: string) => {
    // Under public portfolio mode, keep the user interface fully clean with no tracking popups
    if (viewMode === 'public') {
      return;
    }
    setToastMessage(msg);
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white flex flex-col font-sans relative selection:bg-yellow-400 selection:text-black antialiased">
      ...
      {/* 4. FOOTER */}
      {viewMode === 'dashboard' && (
        <footer className="py-8 bg-black mt-12 border-t border-zinc-950 text-center text-stone-500 text-xs font-mono font-sans">
